...
public class DBAppointment {
    ...
    public static ObservableList<Appointment> getApptsByWeek() {
        ...
        try {
            PreparedStatement stmt = DBConnection.getConnection().prepareStatement(getApptsByWeekSQL);
    ...
    public static ObservableList<Appointment> getApptsByMonth() {
        ...
        try {
            PreparedStatement stmt = DBConnection.getConnection().prepareStatement(getApptsByMonthSQL);
            ResultSet rs = stmt.executeQuery();
    ...
    public static ObservableList<Appointment> getApptsByUser() {
        ...
        try {
            PreparedStatement stmt = DBConnection.getConnection().prepareStatement(getApptsByUserSQL);
            ResultSet rs = stmt.executeQuery();
    ...
    public Appointment getApptById(int appointmentId) {
        ...
        try {
            PreparedStatement stmt = DBConnection.getConnection().prepareStatement(getApptByIdSQL);
    ...
    public static Appointment addAppointment(Appointment appointment) {
        ...
        try {
            PreparedStatement stmt = DBConnection.getConnection().prepareStatement(addAppointmentSQL);
            stmt.setInt(1, appointmentId);
    ...
    public static void updateAppointment(Appointment appointment) {
        ...
        try {
            PreparedStatement stmt = DBConnection.getConnection().prepareStatement(updateApptSQL);
    ...
    public static void deleteAppointment(Appointment appointment) {
        ...
        try {
            PreparedStatement stmt = DBConnection.getConnection().prepareStatement(deleteAppointmentSQL);
